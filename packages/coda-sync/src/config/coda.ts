...
export const CODA_CONFIG = {
    ...
    /**
     * Anatomy table ID from environment variable
     * The ID of the anatomy table
     */
    getAnatomyTableId: () => process.env.CODA_ANATOMY_TABLE_ID,

    /**
     * Decision log table ID from environment variable
     * The ID of the decision log table
     */
    getDecisionLogTableId: () => process.env.CODA_DECISIONLOG_TABLE_ID,
} as const
